...
public class PersonaController {
   ...
   @GetMapping()
    ...
    @PutMapping("/{id}/materia/{materia_id}")
    public void addMateriaToPersona(@PathVariable Integer id,@PathVariable Integer materia_id){
        personaService.addMateriaToPersona(id,materia_id);
    }
